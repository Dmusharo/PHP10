...
//Lesson 3. Task 9
// Остаток деления
echo 10%3; // Нужно разаобраться почему, ведь 10/3 =2,666666667
$a=10;
$b=3;
$c=$a%$b;
echo $c;
//потому что выводистч логическая величина либо есть либо нет. А не сам остаток.
...
$a=2**10;
echo $a;
// Возведение в степень имеет приортет над делением и умножением
//2
$a=3*2**3;
echo $a;
//3
...
//Lesson 3. Task 11
//Строки. Задаються с помощью ковычек . Конкатенация- оперетор точка
$str="Hello";
echo $str;

$str1='abc';
$str2='def';
echo $str1.$str2; // пробелы пишуться отлельно ." ".
...
$str3='wazzap';
echo strlen("$str3");
// Пробелмы с кирилицой. Считает одну букву два раза. Поэутому лучше использовать mb_stlen
echo mb_strlen('абвгд'); // ошибка при выводе??
